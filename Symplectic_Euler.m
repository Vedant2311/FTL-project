...
k_s = 3000.0;   %Spring Force Constant
...
%      s = strcat('C:\Users\Lenovo\Downloads\FTL-project-master\Images_SE\test-00',int2str(count));
       s = strcat('/home/vedant/Downloads/FTL-project/Images_SE/test-00',int2str(count));

     elseif count < 100  
%       s = strcat('C:\Users\Lenovo\Downloads\FTL-project-master\Images_SE\test-0',int2str(count));      
       s = strcat('/home/vedant/Downloads/FTL-project/Images_SE/test-0',int2str(count));

     else   
%         s = strcat('C:\Users\Lenovo\Downloads\FTL-project-master\Images_SE\test-',int2str(count));        
       s = strcat('/home/vedant/Downloads/FTL-project/Images_SE/test-',int2str(count));
     end
