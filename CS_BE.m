...
k_s = 0.0;   % The spring constant
k_d = 0.0;    %damping constant
...
path = '/home/vedant/Downloads/FTL-project/plot_data/CS_BE_temp_1/'; 
...
%         s = strcat('C:\Users\Lenovo\Downloads\FTL-project-master\Images_CS_BE\test-00',int2str(count));
          s = strcat('/home/vedant/Downloads/FTL-project/Images_CS_BE_temp_1/test-00',int2str(count));

     elseif count < 100  
%         s = strcat('C:\Users\Lenovo\Downloads\FTL-project-master\Images_CS_BE\test-0',int2str(count));      
          s = strcat('/home/vedant/Downloads/FTL-project/Images_CS_BE_temp_1/test-0',int2str(count));
         
     else   
%         s = strcat('C:\Users\Lenovo\Downloads\FTL-project-master\Images_CS_BE\test-',int2str(count));        
          s = strcat('/home/vedant/Downloads/FTL-project/Images_CS_BE_temp_1/test-',int2str(count));         
     end
