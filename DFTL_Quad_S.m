...
for t= 2:totalTimeFrames
    ...
    s_damp = 0.9 - 0.8 * (t^2/(totalTimeFrames^2));
    
end

%figure,plot(cell2mat(Eplot_X),cell2mat(Eplot_Y));
path = '/home/vedant/Downloads/FTL-project/plot_data/DFTL_Quad/'; 
...
for t = 1: 1: totalTimeFrames
    ...
    for i = 1 : size-1
     ...
     if count < 10  
%      s = strcat('C:\Users\Lenovo\Downloads\FTL project\Images_DFTL_Quad_S\test-00',int2str(count));
       s = strcat('/home/vedant/Downloads/FTL-project/Images_DFTL_Quad_S/test-00',int2str(count));
     elseif count < 100  
%       s = strcat('C:\Users\Lenovo\Downloads\FTL project\Images_DFTL_Quad_S\test-0',int2str(count));      
       s = strcat('/home/vedant/Downloads/FTL-project/Images_DFTL_Quad_S/test-0',int2str(count));

     else   
%         s = strcat('C:\Users\Lenovo\Downloads\FTL project\Images_DFTL_Quad_S\test-',int2str(count));        
       s = strcat('/home/vedant/Downloads/FTL-project/Images_DFTL_Quad_S/test-',int2str(count));
